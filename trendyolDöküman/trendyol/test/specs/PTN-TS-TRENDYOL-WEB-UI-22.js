...
describe('PTN-TS-TRENDYOL-WEB-UI-22', () => {
    it('Product Select', async () => {
        ...
        await HomePage.productImg.isExisting();
        await HomePage.productName.isExisting();
        await HomePage.price.isExisting();
        await HomePage.addBasket.isClickable();
        await browser.pause(3000);
